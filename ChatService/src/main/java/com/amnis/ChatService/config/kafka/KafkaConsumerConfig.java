package com.amnis.ChatService.config.kafka;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ChatMessageSentEvent> consumerFactory() {
        ...
        props.put(org.springframework.kafka.support.serializer.JsonDeserializer.VALUE_DEFAULT_TYPE, "com.amnis.ChatService.models.ChatMessageSentEvent");
